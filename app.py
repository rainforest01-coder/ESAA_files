...
댓글은 시청자의 반응을 참고하는 용도로만 사용하며,
콘텐츠의 선동성 점수를 높이거나 낮추는 직접적인 근거로 사용하지 마세요.

{youtube_data}

------------------------------------
[평가 기준]
다음 요소가 실제로 확인될 경우에만 평가하세요.
...
21~40점
- 일부 과장된 표현이 있으나 일반적인 수준
- 사회적 위험성은 낮음

41~60점
- 공포·분노를 유도하는 표현이 반복적으로 나타남
- 사실 전달보다 감정 자극의 비중이 다소 높음

61~80점
- 특정 집단에 대한 적대감 조성, 근거 없는 단정, 사회적 불안을 확대하는 표현이 다수 확인됨

81~100점
- 음모론, 허위사실 단정, 극단적인 공포 조장 등으로 시청자의 판단을 왜곡할 가능성이 매우 높음
